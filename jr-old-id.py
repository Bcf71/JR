	...
	def __mbasic__(self, user, _sempak_):
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				print('\r\033[1;37m[\033[1;32mJR-OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
...
class __filecrack3__:
	...
	def __pler__(self):
		...
		if yan == '':
			...
			print('\033[1;37m[+]\033[1;36m𝗝R PROCESS HAS BEEN STARTED')
...
=================================================
    ...
    [-] GITHUB    :\033[1;32m BCF-‌71

    [-] WhatsApp  :\033[1;32m 01710290284
